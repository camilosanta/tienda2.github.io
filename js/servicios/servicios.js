...
var creandoProducto = async () => {
 // creando fecth APPI (fetch viene por defecto con el metodo http = GET)
    const respuesta = await fetch("  https://my-json-server.typicode.com/camilosanta/APPI_AluraGeekTienda.github.io/imagen");
...
var publicandoNuevoProducto = (url,nombre,precio,categoria,eliminar,editar,vermas) =>{
    return fetch("https://my-json-server.typicode.com/camilosanta/APPI_AluraGeekTienda.github.io/imagen",{
        method:"POST",
        headers:{
...
// funcion para eliminar producto 
   const eliminarProductoprin = (id) =>{
    ...
    return fetch(`https://my-json-server.typicode.com/camilosanta/APPI_AluraGeekTienda.github.io/imagen/${id}`,{
        method: "DELETE",
...
const detallesProducto = (id) =>{
    return fetch(`https://my-json-server.typicode.com/camilosanta/APPI_AluraGeekTienda.github.io/imagen/${id}`).then((respuesta) =>  respuesta.json());
};
